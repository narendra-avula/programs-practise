...
# use the file write new function that you have written, copy it over and add a bufsize parameter and do your measurements
# collect your measurements in lists and then have the charting logic..
