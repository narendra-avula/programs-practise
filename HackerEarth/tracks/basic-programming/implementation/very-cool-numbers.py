...
et the coins be numbered 1 to 3 from left to right. In second testcase,

Alice removes coin numbered 2. Now Bob cannot win the game.
'''

test_cases = int(raw_input())
for _ in range(test_cases):
    no_of_moves = int(raw_input())
    print "Alice"