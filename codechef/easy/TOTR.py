...
#
# lower_letters_dict = dict(zip(ascii_lowercase, list(string)))
# print(lower_letters_dict)
# print(lower_letters_dict['p']+lower_letters_dict['h'])

from string import ascii_lowercase
test_cases , M = input().split()
lower_letters_dict = dict(zip(ascii_lowercase, list(M)))
...
for _ in range(int(test_cases)):
    ...
    for i in sentence:
        if i.isupper():
            i = i.lower()
            new_sentence += lower_letters_dict[i].upper()
        elif i == '_' :
            new_sentence += ' '
        elif i.islower():
            new_sentence += lower_letters_dict[i]
        else:
            new_sentence += i
    print(new_sentence)
