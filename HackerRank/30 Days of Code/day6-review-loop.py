...
'''
Objective
Today we're expanding our knowledge of Strings and combining it with what we've already

learned about loops. Check out the Tutorial tab for learning materials and an instructional video!
...
for _ in range(int(raw_input())):
    ...
    print ''.join(i for i in string[0::2]) + ' ' + ''.join(i for i in string[1::2])
